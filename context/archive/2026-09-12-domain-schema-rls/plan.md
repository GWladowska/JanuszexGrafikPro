...
- [x] 4.1 `npx supabase migration list --linked` pokazuje zgodność wersji — 8fc8a89

#### Manual

- [x] 4.2 `npx supabase link` wykonany na projekcie produkcyjnym — 8fc8a89
- [x] 4.3 `npx supabase db push` stosuje migracje na produkcji — 8fc8a89
- [x] 4.4 Zdalna baza ma tabele i RLS (smoke test w Studio) — 8fc8a89
- [x] 4.5 Potwierdzone, że seed nie trafił na produkcję — 8fc8a89
