...
1. **Czy kolizja z niedostępnością pracownika ma być ostrzeżeniem czy twardym blokiem?** — zanotowane pod FR-010 ("ostrzeżenie vs twardy blok do rozstrzygnięcia na etapie projektowania"). Owner: user.
2. **Czy zapisany grafik ma pozostać edytowalny?** — zanotowane pod FR-011 ("Pytanie otwarte: ... do rozstrzygnięcia"). Owner: user.
