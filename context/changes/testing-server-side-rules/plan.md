...
- [ ] 3.1 Suity `schedule-freeze` i `availability-freeze` przechodzą: `npm run test:integration`
- [ ] 3.2 `npm run lint` przechodzi
- [ ] 3.3 `npm run check` przechodzi
...
- [ ] 6.4 PR pokazuje zielony job `integration` obok szybkiego joba jakościowego
- [ ] 6.5 Cookbook §6.4 i ledger §8 opisują proces zgodny z tym, co faktycznie działa
